            ...
            <div className="p-4 slide-in-top">
                ...
                <div className="row">
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls1" className="carousel slide my-1" data-bs-ride="carousel">
                            ...
                            <div className="row d-flex justify-content-center">
                                <a href="https://leenajabr.github.io/Challenge-6-Weather-APP/" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><BsLaptop/> Watch Live</a>
                                <a href="https://github.com/LeenaJabr/Challenge-6-Weather-APP" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><AiFillGithub/> Source Code</a>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div>
                            <h5 className="ff-jose my-1">Books Browser</h5>
                            <div className="row d-flex justify-content-center">
                                <a href="https://leenajabr.github.io/Challenge-21-MERN/" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><BsLaptop/> Watch Live</a>
                                <a href="https://github.com/LeenaJabr/Challenge-21-MERN" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><AiFillGithub/> Source Code</a>
                            </div>
                        </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls3" className="carousel slide my-1" data-bs-ride="carousel">
                            ...
                            <h5 className="ff-jose my-1">Note-Taker</h5>
                            <div className="row d-flex justify-content-center">
                                <a href="https://github.com/LeenaJabr/Challenge-11-Express.js" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><AiFillGithub/> Source Code</a>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls4" className="carousel slide my-1" data-bs-ride="carousel">
                            ...
                            <h5 className="ff-jose my-1">Medical-Translator</h5>
                            <div className="row d-flex justify-content-center">
                                <a href="https://github.com/adamwagh512/Medical-Translator" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><BsLaptop/> Watch Live</a>
                                <a href="https://github.com/adamwagh512/Medical-Translator" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><AiFillGithub/> Source Code</a>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls5" className="carousel slide my-1" data-bs-ride="carousel">
                            ...
                            <h5 className="ff-jose my-1">ReadMe Generator</h5>
                            <div className="row d-flex justify-content-center">
                                <a href="https://github.com/LeenaJabr/Challenge-9-Professional-ReadMe-Generator" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><AiFillGithub/> Source Code</a>
                            </div>
